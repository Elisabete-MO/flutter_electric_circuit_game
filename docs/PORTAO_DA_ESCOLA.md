...
- Entender controle indireto: uma corrente em um circuito altera outro circuito.
...
```text
circuito de comando: fonte -> botao -> bobina
                              |
                              v
circuito de carga:   fonte -> contato -> carga simulada
```
