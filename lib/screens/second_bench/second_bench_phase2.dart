...
/// Tela da Fase 2 do Segundo Estande (Acende Aí): Inspecione o circuito pré-montado.
...
class _SecondBenchPhase2State extends State<SecondBenchPhase2> with SingleTickerProviderStateMixin {
...
class CircuitWirePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Fio 1: Bateria Positivo -> Resistor
    final path1 = Path();
