...
/// Tela da Fase 4 — Bancada livre do Segundo Estande (Acende Aí)
...
class _SecondBenchPhase4State extends State<SecondBenchPhase4> {
  ...
  void _addComponentAtRelativePosition(Phase4LibraryItem item, Offset relativePos) {
    ...
    // Regras de limite para o Estande
                ...
                return Listener(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      // Botões de Remoção Interativos sobre os fios
