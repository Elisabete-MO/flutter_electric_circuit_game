...
class _MovimentoMiniaturaScreenState extends State<MovimentoMiniaturaScreen>
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: GoogleFonts.rajdhani(
                        color: _m2ReversedPolarity ? const Color(0xFF10B981) : Colors.amber,
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
                      ),
                    ),
                    ...
                    ElevatedButton.icon(
                      ...
                      icon: const Icon(Icons.sync_alt_rounded, color: Colors.amber),
                      label: Text(
                        _m2ReversedPolarity
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(
                                  ...
                                  color: _m3PushButtonInserted ? const Color(0xFF10B981) : Colors.amber,
                                ),
                    ...
                    if (_m3PushButtonInserted)
                      GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            color: _m3PushButtonPressed ? const Color(0xFF10B981) : const Color(0xFF0284C7),
                            borderRadius: BorderRadius.circular(16),
                            boxShadow: [
                              BoxShadow(
                                color: (_m3PushButtonPressed ? const Color(0xFF10B981) : const Color(0xFF0284C7)).withValues(alpha: 0.5),
                                blurRadius: 16,
                              ),
                            ],
                          ),
                        ...
                        Column(
                          children: [
                            Icon(
                              ...
                              size: 48,
                              color: isSystemReady ? const Color(0xFF10B981) : Colors.white24,
                            ),
                          ...
                          builder: (context, candidateData, rejectedData) {
                            return InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: _m4LedInserted ? const Color(0xFF064E3B) : const Color(0xFF1E293B),
                                  borderRadius: BorderRadius.circular(12),
                                  border: Border.all(color: _m4LedInserted ? const Color(0xFF10B981) : Colors.amber),
                                ),
                                child: Row(
                                  children: [
                                    Icon(_m4LedInserted ? Icons.check_circle_rounded : Icons.add_box_rounded, color: _m4LedInserted ? const Color(0xFF10B981) : Colors.amber),
                          ...
                          builder: (context, candidateData, rejectedData) {
                            return InkWell(
                              ...
                              child: Container(
                                padding: const EdgeInsets.all(12),
                                decoration: BoxDecoration(
                                  color: _m4ResistorInserted ? const Color(0xFF064E3B) : const Color(0xFF1E293B),
                                  borderRadius: BorderRadius.circular(12),
                                  border: Border.all(color: _m4ResistorInserted ? const Color(0xFF10B981) : Colors.amber),
                                ),
                                child: Row(
                                  children: [
                                    Icon(_m4ResistorInserted ? Icons.check_circle_rounded : Icons.add_box_rounded, color: _m4ResistorInserted ? const Color(0xFF10B981) : Colors.amber),
                                    const SizedBox(width: 8),
                                    Text(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        const Icon(Icons.directions_car_filled_rounded, size: 72, color: Colors.amberAccent),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: _m5WireRepaired ? const Color(0xFF10B981) : Colors.amber),
                      ),
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(
                            ...
                            color: _m5WireRepaired ? const Color(0xFF10B981) : Colors.amber,
                          ),
                          const SizedBox(width: 10),
                          Text(
                            _m5WireRepaired
                    ...
                    Row(
                      ...
                      children: [
                        ElevatedButton.icon(
                          style: ElevatedButton.styleFrom(
                            backgroundColor: _m5WireRepaired ? const Color(0xFF064E3B) : const Color(0xFF1E293B),
                            side: BorderSide(color: _m5WireRepaired ? const Color(0xFF10B981) : Colors.amber),
                          ),
                          icon: const Icon(Icons.handyman_rounded, color: Colors.amber),
                          label: Text(
  ...
  Widget _buildMissionTitleHeader() {
    return WorkbenchMissionHeader(
      title: _currentMission.title,
      objective: _currentMission.objective,
    );
  }
