...
class _MovimentoMiniaturaScreenState extends ConsumerState<MovimentoMiniaturaScreen>
  ...
  // ==========================================
  // ESQUEMÁTICO 1: Primeiro Giro do Motor
  // ==========================================
  Widget _buildM1Schematic() {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final wires = <WirePath>[];
        if (_m1BatteryInserted && _m1MotorInserted) {
          wires.add(DynamicWirePath.fromComponents(
            compA: batteryPlacement,
            terminalIndexA: 1,
            compB: motorPlacement,
  ...
  // ==========================================
  // ESQUEMÁTICO 2: Inversão de Sentido de Rotação
  // ==========================================
  ...
  // ==========================================
  // ESQUEMÁTICO 3: Botão de Partida do Motor
  // ==========================================
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: SchematicBlueprintSocket<String>(
                          ...
                          onRotate: () {},
                          onTap: () => setState(() => _m3PushButtonPressed = !_m3PushButtonPressed),
                          symbolWidget: const SchematicSwitchWidget(size: 55, isPushButton: true, color: Color(0xFFEF4444)),
                          placeholderWidget: const SchematicSwitchWidget(size: 48, isPushButton: true, color: Color(0xFF94A3B8)),
                          label: '',
                        ),
                      ),
                      Positioned(
  ...
  // ==========================================
  // ESQUEMÁTICO 4: Painel com LED Indicador em Paralelo
  // ==========================================
  ...
  // ==========================================
  // ESQUEMÁTICO 5: Diagnóstico do Mini Carrinho
  // ==========================================
