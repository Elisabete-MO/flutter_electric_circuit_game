...
import 'missions/ruas_maquete_m1.dart';
import 'missions/ruas_maquete_m2.dart';
import 'missions/ruas_maquete_m3.dart';
import 'missions/ruas_maquete_m4.dart';
import 'missions/ruas_maquete_m5.dart';

/// Coordenador do fluxo de missões do Estande 04 — Ruas da Maquete (Equipe Bairro).
  ...
  void _onMissionCompleted(int missionNumber) {
    ...
    if (missionNumber == 5) {
      ref
          ...
          .markAsCompleted('estande4', stars: 3);
      ref
          .read(progressControllerProvider.notifier)
          .markAsCompleted('ruas_maquete', stars: 3);
          ...
          child: GlassContainer(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Parabéns! A Equipe Bairro iluminou as Ruas da Maquete com circuitos em série e em paralelo, garantindo independência nas casas!',
                  style: TextStyle(
