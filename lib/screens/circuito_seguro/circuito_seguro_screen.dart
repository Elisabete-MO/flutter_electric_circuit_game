...
import 'missions/circuito_seguro_m1.dart';
import 'missions/circuito_seguro_m2.dart';
import 'missions/circuito_seguro_m3.dart';
import 'missions/circuito_seguro_m4.dart';
import 'missions/circuito_seguro_m5.dart';

/// Coordenador do fluxo de missões do Estande 08 — Circuito Seguro (Equipe Segurança).
class CircuitoSeguroScreen extends ConsumerStatefulWidget {
  const CircuitoSeguroScreen({super.key});

  @override
  ConsumerState<CircuitoSeguroScreen> createState() =>
      _CircuitoSeguroScreenState();
}

class _CircuitoSeguroScreenState extends ConsumerState<CircuitoSeguroScreen> {
  ...
  void _onMissionCompleted(int missionNumber) {
    ...
    if (missionNumber == 5) {
      ref
          ...
          .markAsCompleted('estande8', stars: 3);
      ref
          .read(progressControllerProvider.notifier)
          .markAsCompleted('circuito_seguro', stars: 3);
          ...
          child: GlassContainer(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Parabéns! A Equipe Segurança dominou a identificação de curtos, teste de continuidade, dimensionamento de fusíveis e auditoria de bancadas!',
                  style: TextStyle(
