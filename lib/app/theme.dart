  ...
  static ThemeData _build(Brightness brightness) {
    ...
    return base.copyWith(
      textTheme: bodyTextTheme.copyWith(
        displayLarge: bodyTextTheme.displayLarge?.copyWith(fontFamily: titleFontFamily, fontWeight: FontWeight.bold, letterSpacing: 1.0),
        displayMedium: bodyTextTheme.displayMedium?.copyWith(fontFamily: titleFontFamily, fontWeight: FontWeight.bold, letterSpacing: 1.0),
        displaySmall: bodyTextTheme.displaySmall?.copyWith(fontFamily: titleFontFamily, fontWeight: FontWeight.bold, letterSpacing: 1.0),
        headlineLarge: bodyTextTheme.headlineLarge?.copyWith(fontFamily: titleFontFamily, fontWeight: FontWeight.bold, letterSpacing: 0.8),
        headlineMedium: bodyTextTheme.headlineMedium?.copyWith(fontFamily: titleFontFamily, fontWeight: FontWeight.bold, letterSpacing: 0.8),
        headlineSmall: bodyTextTheme.headlineSmall?.copyWith(fontFamily: titleFontFamily, fontWeight: FontWeight.bold, letterSpacing: 0.8),
        titleLarge: bodyTextTheme.titleLarge?.copyWith(fontFamily: titleFontFamily, fontWeight: FontWeight.bold, letterSpacing: 0.5),
        titleMedium: bodyTextTheme.titleMedium?.copyWith(fontFamily: titleFontFamily, fontWeight: FontWeight.bold, letterSpacing: 0.5),
        titleSmall: bodyTextTheme.titleSmall?.copyWith(fontFamily: titleFontFamily, fontWeight: FontWeight.bold, letterSpacing: 0.5),
      ).apply(
