...
class StandMission {
  ...
  static List<StandMission> get estande3Missions => const [
        ...
        StandMission(
          ...
          standId: 'liga_desliga',
          number: 5,
          title: 'Controle por Botão de Pressão',
          objective: 'Montar um botão de pressão para uma luz que só fica acesa enquanto o visitante o mantém pressionado.',
          componentsInfo: 'Bateria, botão de pressão, lâmpada',
          victoryCriteria: 'Luz permanece acesa apenas enquanto o visitante mantém o botão pressionado',
  ...
  static List<StandMission> get movimentoMiniaturaMissions => const [
        ...
        StandMission(
          ...
          standId: 'movimento',
          number: 3,
          title: 'Partida por Botão de Pressão',
          objective: 'Instalar botão de pressão para que o motor só funcione enquanto o botão estiver pressionado.',
          componentsInfo: 'Bateria, motor CC, interruptor tipo botão de pressão',
          victoryCriteria: 'Acionar o motor mantendo o botão de pressão pressionado e observar a interrupção ao soltar',
          failureFeedback: 'O botão deve interromper a rota da corrente quando solto.',
          voltsMediation: voltsMediationEstandeMovimentoMiniatura,
        ),
        StandMission(
